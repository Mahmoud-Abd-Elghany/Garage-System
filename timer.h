...
/*
	Function Name        : timer_OVF_interrupt_Callback
	Function Returns     : void
	Function Arguments   : callback function, time in seconds
	Function Description : initialize the overflow mode of timer0 with interrupt to callback function upon completion.
*/
void timer_OVF_interrupt_Callback(void (*callback_func)(void),unsigned char time_sec);
